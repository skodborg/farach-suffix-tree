...
def faked_tree_article():
    ...
    inner2 = utils.Node([2,1,3], "10")
    inner1.add_child(inner2)
    inner2 = utils.Node([3], "12")
    inner1.add_child(inner2)
    inner1 = utils.Node([2], "inner")
    t_even.add_child(inner1)
    inner2 = utils.Node([1,2,2,1,2,1,3], "6")
    inner1.add_child(inner2)
    inner2 = utils.Node([2], "inner2")
    inner1.add_child(inner2)
    inner3 = utils.Node([1,2,1,3], "8")
    ...
    inner1.add_child(inner2)
    inner2 = utils.Node([2,2], "inner")
    inner1.add_child(inner2)
    inner3 = utils.Node([1,2,1,3], "7")
    inner2.add_child(inner3)
    inner3 = utils.Node([2,1,2,2,1,2,1,3], "3")
    inner2.add_child(inner3)
    inner1 = utils.Node([2], "inner")
    t_odd.add_child(inner1)
    inner2 = utils.Node([1], "inner")
    inner1.add_child(inner2)
    inner3 = utils.Node([2,1,3], "9")
    inner2.add_child(inner3)
    inner3 = utils.Node([3], "11")
    inner2.add_child(inner3)
    inner2 = utils.Node([2,1,2,2,1,2,1,3], "5")
    inner1.add_child(inner2)
...
def faked_tree_book():
    ...
    inner1.add_child(inner2)
    inner3 = utils.Node([1,1,1,2,2,1,2,2,2,1,3], "1")
    inner2.add_child(inner3)
    inner3 = utils.Node([2,1,2,2,2,1,3], "5")
    inner2.add_child(inner3)
    inner1 = utils.Node([2], "inner")
    t_odd.add_child(inner1)
    inner2 = utils.Node([1], "inner")
    inner1.add_child(inner2)
    inner3 = utils.Node([2,2,2,1,3], "7")
    inner2.add_child(inner3)
    inner3 = utils.Node([3], "11")
    inner2.add_child(inner3)
    inner2 = utils.Node([2,2,1,3], "9")
    inner1.add_child(inner2)
    inner1 = utils.Node([3], "13")
    t_odd.add_child(inner1)
    ...
    inner1.add_child(inner2)
    inner2 = utils.Node([2,2,2,1,3], "8")
    inner1.add_child(inner2)
    inner2 = utils.Node([3], "12")
    inner1.add_child(inner2)
    inner1 = utils.Node([2], "inner")
    t_even.add_child(inner1)
    inner2 = utils.Node([1,1,1,2,2,1,2,2,2,1,3], "2")
    inner1.add_child(inner2)
    inner2 = utils.Node([2,1], "inner2")
    inner1.add_child(inner2)
    inner3 = utils.Node([2,2,2,1,3], "6")
    inner2.add_child(inner3)
    inner3 = utils.Node([3], "10")
    inner2.add_child(inner3)
    ...
    inner2 = utils.Node([1], "inner")
    inner1.add_child(inner2)
    inner3 = utils.Node([1,1,2,2,1,2,2,2,1,3], "2")
    inner2.add_child(inner3)
    inner3 = utils.Node([2,2,2,1,3], "7")
    inner2.add_child(inner3)
    inner3 = utils.Node([3], "11")
